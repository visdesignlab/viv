 ...
 * @ignore
 */
declare const MultiscaleImageLayer: new <S extends string[]>(...props: _vivjs_types.Viv<LayerProps$7, S>[]) => any;
 ...
 * @ignore
 */
declare const ImageLayer: new <S extends string[]>(...props: _vivjs_types.Viv<LayerProps$6, S>[]) => any;
 ...
 * @ignore
 */
declare const OverviewLayer: new <S extends string[]>(...props: _vivjs_types.Viv<LayerProps$5, S>[]) => any;
 ...
 * @ignore
 */
declare const ScaleBarLayer: new (...props: LayerProps$4[]) => any;
 ...
 * @ignore
 */
declare const VolumeLayer: new <S extends string[]>(...props: _vivjs_types.Viv<LayerProps$3, S>[]) => any;
 ...
 * @ignore
 */
declare const XRLayer: new (...props: _vivjs_types.Viv<LayerProps$2>[]) => any;
 ...
 * @ignore
 */
declare const XR3DLayer: new <S extends string[]>(...props: _vivjs_types.Viv<LayerProps$1>[]) => any;
 ...
 * @ignore
 */
declare const BitmapLayer: new (...props: _vivjs_types.Viv<LayerProps>[]) => any;
